            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        ...
                        <td>
                            <input id="edd_wbcom_ldd_license_key" name="edd_wbcom_ldd_license_key" type="text" class="regular-text" readonly="readonly" value="<?php echo esc_attr( $license ); ?>" />
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table wb-license-form-table">
            <tr>
                ...
                <td class="wb-plugin-license-key"><input id="edd_wbcom_ldd_license_key" name="edd_wbcom_ldd_license_key" type="text" class="regular-text" readonly="readonly" value="<?php echo esc_attr( $license ); ?>" /></td>
