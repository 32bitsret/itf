...
class Ld_Dashboard_Admin {
	...
	public function ld_dashboard_get_custom_preset_fields_callback() {
		...
		<div class="ld-single-grid">
			...
			<div class="ld-dashboard-color-options-value ld-dashboard-grid-content">
	...
	public function ld_dashboard_get_instructors_listing_callback() {
		...
		if ( ! empty( $instructors ) ) {
			...
			<span class="ld-decription"><?php esc_html_e( 'You have to select all instructors which you want to start meeting as co-host. If not selected all instructors will start meeting.', 'ld-dashboard' ); ?></span>
			<?php
		}
		echo ob_get_clean();
		exit;
		...
		<div class="wrap">
			...
			<div class="ld-dashboard-admin-header">
				...
				<h1 class="wbcom-plugin-heading">
					<?php esc_html_e( 'LearnDash Dashboard Settings', 'ld-dashboard' ); ?>
				</h1>
			</div>
