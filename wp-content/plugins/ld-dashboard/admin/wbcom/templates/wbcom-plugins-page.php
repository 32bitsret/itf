<div class="wrap">
	...
	<div class="wbcom-wrap">
		...
		?>
		<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Paid Addons', 'ld-dashboard' ); ?></h4>
		...
		<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Free Addons', 'ld-dashboard' ); ?></h4>
		<div class="reign-demos-wrapper reign-importer-section">
			<div class="reign-demos-inner-wrapper wbcom-plugins-inner-wrapper">
				<?php
				foreach ( $free_plugins as $key => $plugin_details ) {
					$plugin_btn_text = esc_html__( 'View', 'ld-dashboard' );
